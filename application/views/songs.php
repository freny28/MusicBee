<div class="col-md-10 offset-md-1">
	...
	<div class="col-md-9">
		<table class="table table-striped responsive">
			<thead class="thead-dark">
				<th scope="col-md-1 col-sm-1">No.</th>
				<th scope="col-md-1 col-sm-1">Add to favorites</th>
				<th scope="col-md-2 col-sm-1">Song</th>
				<th scope="col-md-1 col-sm-1">Artist/Singer</th>
				<th scope="col-md-1 col-sm-1">Music Director/Band</th>
				<th scope="col-md-1 col-sm-1">Genre</th>
				<th scope="col-md-1 col-sm-1">Edit Song</th>
				<th scope="col-md-1 col-sm-1">Delete Song</th>
			</thead>
			<tbody>
	...
	<div class="col-md-3">
		<?if($sameSong){ ?><p class="text-danger col-md-12">Song is already on your list</p> <? } ?>
		<?if($add_song){ ?><p class="text-success col-md-12">Song Added!</p> <? } ?>
		<? if($update_success){ ?> <p class="text-success col-md-12 offset-md-5"> Updated Song </p> <? } ?>
		<form method="post"  class="col-md-12 responsive" action="<?php echo base_url()?>index.php?/Songs/addSong">
			<div class="form-group">
				<label class="col-md-12 text-center pb-10" for="song">Song Name</label>
				<div class="input-group col-md-12">
					<input type="text" name="song" id="song" class="form-control col-md-10 offset-md-1"  required="required">
				</div>
			</div>
			<div class="form-group">
				<label class="col-md-12 text-center pb-10" for="artist">Artist/Singer Name</label>
				<div class="input-group col-md-12 ">
					<input type="text" name="artist" id="artist" class="form-control col-md-10 offset-md-1" >
				</div>
			</div>
			<div class="form-group">
				<label class="col-md-12 text-center pb-10" for="band">Music Director/Band Name</label>
				<div class="input-group col-md-12 ">
					<input type="text" name="band" id="band" class="form-control col-md-10 offset-md-1">
				</div>
			</div>
			<div class="form-group">
				<label class="col-md-12 text-center pb-10" for="genere">Genre</label>
				<div class="input-group col-md-12 ">
					<input type="text" name="genere" id="genere" class="form-control col-md-10 offset-md-1">
				</div>
			</div>
			<div class="form-group">
				<label class="col-md-12 text-center pb-10" for="favorite">Favorite</label>
				<div class="input-group col-md-12 offset-md-5 ">
					<input type="checkbox" data-toggle="toggle" name="favorite" id="favorite" class="form-control col-md-2 ">
				</div>
			</div>
